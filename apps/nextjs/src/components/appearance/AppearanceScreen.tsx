...
export const AppearanceScreen = () => {
  ...
  const avatarPlaceholder = profileData?.handle
    ? profileData?.handle[1]?.toUpperCase()
    : "@";
      ...
      <Form onSubmit={handleSubmit}>
        <RoundedBox css={{ mb: "2rem" }}>
          ...
          >
            ...
            >
              <Box>
                <AvatarPlaceholder handle={profileData.handle} />
              </Box>
              <Flex
                css={{
                  flexDirection: "column",
        ...
        <Button type="submit" disabled={isSubmitting} css={{ fontSize: "$xl" }}>
          Update Profile
        </Button>
      </Form>
    </>
